...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        use_first: Optional[bool] = None,

        return_dict: Optional[bool] = None,
        return_custom: Optional[bool] = None,
        tokenizer=None,

        use_pai: Optional[bool] = None,
        ...
        num_attn_candidates: Optional[int] = None,
        ...
        outputs = self.model(
            ...
            # output_hidden_states=output_hidden_states, # CBS Fix: Original
            output_hidden_states=output_hidden_states or early_exit_layers is not None, # CBS Fix: For DoLa
